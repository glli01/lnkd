  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900 dark:to-purple-900">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
        ...
        >
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-bold mb-8 tracking-tighter flex items-center justify-center">
            <Linkedin className="mr-4 h-12 w-12 md:h-16 md:w-16 text-blue-600 dark:text-blue-300" />
          ...
          >
            <Link href="/linkd/score-calculator">
              <Button
                variant="ghost"
